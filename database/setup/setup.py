...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'smart_service_type') THEN
    CREATE DOMAIN public.smart_service_type AS TEXT CHECK (VALUE IN (
      ...
      'aqlli_termostat_iqlim_nazarati_tizimlari','smart_lock_internet_orqali_boshqariladigan_eshik_qulfi_tizimlari',
      'aqlli_rozetalar_energiya_monitoring_tizimlari','uyni_masofadan_boshqarish_qurilmalari_yagona_uzim_orqali_boshqarish',
      ...
      'domofon_tizimlari_ornatish','xavfsizlik_signalizatsiyasi_harakat_sensorlarini_ornatish',
      ...
      'bulutli_fayl_almashish_zaxira_tizimlari','vpn_va_xavfsiz_internet_ulanishlarini_tashkil_qilish',
      'quyosh_panellarini_ornatish_ulash','quyosh_batareyalari_orqali_energiya_saqlash_tizimlari',
      ...
      'ip_telefoniya_mini_ats_tizimlarini_tashkil_qilish','video_konferensiya_tizimlari',
